        ...
        <div className="flex flex-col gap-12 items-center justify-center w-full">
          ...
          <div className="master-container w-full bg-black/40 p-8 rounded-2xl backdrop-blur-sm border border-white/10">
            ...
            <div className="master-content text-left">
              ...
              <p className="text-pink-400 font-medium mb-4">Senior Dance Instructor</p>
              <p className="text-gray-200 leading-relaxed max-w-2xl">
                Rajesh K is an experienced dance instructor who specializes in training students in both classical and modern dance styles. Known for his disciplined teaching approach and attention to detail, he helps students master fundamentals while encouraging creativity and confidence on stage.
              </p>
            </div>
          </div>
          ...
          <div className="master-container w-full bg-black/40 p-8 rounded-2xl backdrop-blur-sm border border-white/10">
            ...
            <div className="master-content text-left">
              <h2 className="text-3xl font-bold mb-2 gradient-text">Sidhu Master</h2>
